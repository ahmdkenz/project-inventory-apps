      ...
      <main class="flex-1 p-6 overflow-y-auto">
        ...
        <div class="bg-white p-4 rounded-lg shadow mb-6 print:hidden">
          <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <input type="text" v-model="filters.recipient" placeholder="Cari penerima..." class="w-full border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-8 md:p-12">
          ...
          <div class="border-b-2 border-gray-900 pb-4 mb-8">
            ...
            <h1 class="text-3xl font-bold text-gray-900 mt-2">Laporan Transaksi Barang Keluar</h1>
            ...
            <table class="w-full min-w-max">
              <thead class="border-b border-gray-300">
                <tr>
                  ...
                  <th class="px-4 py-3 text-left text-sm font-medium text-gray-600 uppercase">Penerima</th>
...
const transactions = ref<SalesOrder[]>([])
const filters = ref({
  start_date: '',
  end_date: '',
  recipient: ''
...
const loadData = async () => {
  try {
    ...
    if (filters.value.recipient) {
      params.recipient = filters.value.recipient
    }

    const response = await axios.get('http://localhost:8000/api/admin/reports/outgoing', {
