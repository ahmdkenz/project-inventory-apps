        ...
        <div v-else-if="receipt">
          <div class="flex items-center justify-between mb-6 print-hidden">
            ...
            <div class="flex space-x-3">
              <router-link to="/admin/received-items" class="bg-white hover:bg-gray-50 border border-gray-300 text-gray-700 font-medium py-2 px-4 rounded-lg flex items-center justify-center space-x-2 transition duration-150">
              ...
              <div class="pt-6 border-t border-gray-200 print-no-break">
                ...
                <div class="grid grid-cols-2 gap-4 text-center">
                  <div>
                    ...
                    <p class="text-xs text-gray-500">Nama Jelas</p>
                  </div>
                  <div>
                    <p class="text-sm text-gray-700 mb-16">Mengetahui,</p>
                    <p class="text-sm font-medium text-gray-900 border-t border-gray-400 pt-1">(Admin / SPV)</p>
                    <p class="text-xs text-gray-500">Nama Jelas</p>
                  </div>
                </div>
              </div>
