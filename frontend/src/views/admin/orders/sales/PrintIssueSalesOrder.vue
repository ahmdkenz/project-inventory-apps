        ...
        <div class="grid grid-cols-3 gap-8 pt-12">
          <div class="text-center">
            ...
            <div class="border-t border-gray-400 pt-1">
              <p class="text-sm font-semibold text-gray-900">{{ salesOrder.processor?.name || salesOrder.creator?.name || '..............................' }}</p>
          ...
          <div class="text-center">
            ...
            <div class="border-t border-gray-400 pt-1">
              <p class="text-sm font-semibold text-gray-900">{{ salesOrder.approver?.name || '..............................' }}</p>
