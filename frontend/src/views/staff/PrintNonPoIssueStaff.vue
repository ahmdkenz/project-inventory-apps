<template>
  <div class="flex h-screen">
    <!-- Sidebar Admin -->
    <StaffNavigation :currentPath="route.path" />
      ...
      <main class="flex-1 p-6 overflow-y-auto">
        <div class="flex items-center justify-between mb-6 print-hidden">
          ...
          <div class="flex space-x-3">
            <router-link to="/staff/outgoing-items" class="bg-white hover:bg-gray-50 border border-gray-300 text-gray-700 font-medium py-2 px-4 rounded-lg flex items-center justify-center space-x-2 transition duration-150">
